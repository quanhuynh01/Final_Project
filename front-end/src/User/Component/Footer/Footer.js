...
<div>
  ...
  <div className="container-fluid bg-dark text-white mt-5 pt-5">
    <div className="row px-xl-5 pt-5">
      <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
        ...
        <p className="mb-2 text-white"><i className="fa fa-envelope text-warning mr-3" />info@example.com</p>
        <p className="mb-0 text-white"><i className="fa fa-phone text-warning mr-3" />+012 345 67890</p>
      </div>
    ...
    <div className="row border-top mx-xl-5 py-4" style={{borderColor: 'rgba(256, 256, 256, .1) !important'}}>
      <div className="col-md-6 px-xl-0">
        <p className="mb-md-0 text-center text-md-left text-white">
          ...
          by
          <a className="text-warning" href="https://htmlcodex.com">HTML Codex</a>
        </p>
      </div>
  ...
  {/* Footer End */}
  {/* Back to Top */}
  {/* <a href="#" className="btn btn-warning back-to-top"><i className="fa fa-angle-double-up" /></a> */}
</div>
