    ...
    >
      <Tab eventKey="bestSeller" title={<h4>Sản phẩm bán chạy</h4>}>
        <div className='d-flex justify-content-center' style={{ flexWrap: "wrap", width: "80%", margin: "auto" }}>
          {products.map((item, i) => (
            <Card className='card-item' key={i} style={{ width: '17.5rem', margin: '10px' }}>
              ...
              <Card.Body>
                <div className='d-flex' style={{ justifyContent: "space-between" }}>
                  <Card.Text>Mã SP:05587</Card.Text>
                  <Card.Text className='text-success'><i className='fa fa-check'></i> Còn hàng</Card.Text>
                </div>
